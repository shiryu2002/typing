...
shion_collection = [
  ...
  "月島蛍（けい）は1年生のMB（ミドルブロッカー）です。高い慎重と優れた洞察力を持っていながらも、入部当初は部活に対して冷めた態度を取っていました。しかし、幼馴染の山口の言葉と、チームメイトや他行の先輩たちとの交流でバレーへの向き合い方が変わっていきます。烏野ブロック陣の柱を担う、相手を執拗に追い詰めるクレバーなブロッカーです。また、全方位にトゲだらけのシニカルな毒舌家でもあり、烏野には珍しいクールな性格です。",
